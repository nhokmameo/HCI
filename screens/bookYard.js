...
export default class bookYard extends Component {
                ...
                <ScrollView style={styles.profile}>
                    ...
                    <View style={styles.Body}>
                        ...
                        <View style={{ flexDirection: 'row', width: '80%', height: 40, marginTop: 10, marginLeft: 20 }}>
                            ...
                            <Text style={{ fontSize: 18, color: '#010401' }}>Mở 05:00 AM- Đóng 22:00 PM</Text>
                        </View>


                        <View style={{ flexDirection: 'row', width: '80%', height: 40, marginTop: 10, marginLeft: 20 }}>
                            <Text style={{ fontSize: 18, color: '#010401' }}> Ngày hoạt động: </Text>
                            <Text style={{ fontSize: 18, color: '#010401' }}>Thứ 2- Chủ Nhật</Text>
                        </View>


                        <View style={{ flexDirection: 'row', width: '80%', height: 40, marginTop: 10, marginLeft: 20 }}>
                            <Text style={{ fontSize: 18, color: '#010401' }}> Giá sân: </Text>
                            <Text style={{ fontSize: 18, color: '#C61818' }}>₫ 65.000/ giờ</Text>
                        </View>
